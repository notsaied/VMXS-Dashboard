                        ...
                        <div class="container-xxl d-flex align-items-stretch justify-content-between">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Title-->
                                <h3 class="text-dark fw-bolder my-1 fs-2"><!--begin::Svg Icon | path: assets/media/icons/duotune/general/gen005.svg-->
<span class="svg-icon svg-icon-muted svg-icon-2hx"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
<path opacity="0.3" d="M19 22H5C4.4 22 4 21.6 4 21V3C4 2.4 4.4 2 5 2H14L20 8V21C20 21.6 19.6 22 19 22ZM15 17C15 16.4 14.6 16 14 16H8C7.4 16 7 16.4 7 17C7 17.6 7.4 18 8 18H14C14.6 18 15 17.6 15 17ZM17 12C17 11.4 16.6 11 16 11H8C7.4 11 7 11.4 7 12C7 12.6 7.4 13 8 13H16C16.6 13 17 12.6 17 12ZM17 7C17 6.4 16.6 6 16 6H8C7.4 6 7 6.4 7 7C7 7.6 7.4 8 8 8H16C16.6 8 17 7.6 17 7Z" fill="black"/>
<path d="M15 8H20L14 2V7C14 7.6 14.4 8 15 8Z" fill="black"/>
</svg></span>
<!--end::Svg Icon--> @yield('page_name',env('APP_NAME'))</h3>
                                <!--end::Title-->
                            </div>
                            <!--end::Left-->
                            <!--begin::Right-->
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-1 ms-lg-6">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold w-300px" data-kt-menu="true">
                                        <div class="menu-content fw-bold d-flex align-items-center bgi-no-repeat bgi-position-y-top rounded-top" style="background-image:url('{{asset('vmxs/images/dropdown-header-bg.jpg')}}')">
                                            <div class="symbol symbol-45px mx-5 py-5">
                                                <span class="symbol-label bg-primary align-items-end">
                                                    <img alt="Logo" src="https://preview.keenthemes.com/start-html-pro/assets/media/svg/avatars/001-boy.svg" class="mh-35px">
                                                </span>
                                            </div>
                                            <div class="">
                                        ...
                                        <div class="row row-cols-2 g-0">
                                            <a href="/start-html-pro/?page=profile/overview" class="border-bottom border-end text-center py-10 btn btn-active-color-primary rounded-0">
                                            ...
                                            <a href="/start-html-pro/?page=profile/account" class="col border-bottom text-center py-10 btn btn-active-color-primary rounded-0">
                                            ...
                                            <a href="/start-html-pro/?page=profile/settings" class="col text-center border-end py-10 btn btn-active-color-primary rounded-0">
                                            ...
                                            <a href="/start-html-pro/?page=general/login" class="col text-center py-10 btn btn-active-color-primary rounded-0">
